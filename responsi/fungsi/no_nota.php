...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- Function --- Buat Nomor Nota</h5>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal"
                                    data-target="#buatNota<?=$nota;?>">
                                    <i class="fa fa-file"></i> Buat Nomor Nota
                                </button>

                            </td>
                        </tr>

                        <div class="modal fade" id="buatNota<?=$nota;?>">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="post">
                                        <div class="modal-body">
                                            Apakah ingin membuat nota <?=$nota?>?
                                            <br> <br>
                                            <input type="hidden" name="nota" value="<?=$nota;?>">
                                            <input type="hidden" name="tanggal" value="<?=$tanggal;?>">
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success"
                                                    name="buatNota">Buat</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <table class="table table-striped table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Pembayaran</th>
                            <th scope="col">Kembalian</th>
                            <th scope="col">Nomor Nota Baru</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
