...
// menjalankan query prosedur sepatu_termahal
$query = "CALL sepatu_termahal()";
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- Prosedur --- Sepatu Termahal</h5>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col" class="px-4"> Sepatu Termahal</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-2 text-center"><?=$row['merk sepatu termahal']; ?></td>
