...
// menjalankan query prosedur sepatu_termurah
$query = "CALL sepatu_termurah()";
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- Prosedur --- Sepatu Termurah</h5>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col class=" px-4""> Merk Sepatu Termurah</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-2 text-center"><?=$row['merk sepatu termurah']; ?></td>
                            <td class="p-2 text-center">Rp.<?=$row['harga sepatu']; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
