...
// menjalankan query pada procedure hitung_total_pembelian

$query = "CALL hitung_total_pembelian()";
...
<head>
    ...
    <title>Prosedur Total Semua Pembelian</title>
</head>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- Prosedur --- Total Semua Pembelian</h5>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col"> Total Semua Pembelian</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($hasil)) { ?>
                        <tr>
                            <td class="p-2">Rp.<?=$row['total semua pembelian']; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
