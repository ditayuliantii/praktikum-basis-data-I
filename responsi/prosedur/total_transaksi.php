...
// menjalankan query pada procedure total_transaksi_pembelian

$query = "CALL total_transaksi_pembelian()";
...
<head>
    ...
    <title>Banyak Transaksi Pembelian</title>
</head>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- Prosedur --- Banyak Transaksi Pembelian Sepatu</h5>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col"> Banyak Transaksi Pembelian Sepatu</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($hasil)) { ?>
                        <tr>
                            <td class="p-2"><?=$row['banyak transaksi pembelian sepatu']; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
