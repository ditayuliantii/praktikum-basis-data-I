...
// menjalankan query SELECT pada view pemasukan_harian
$query = "SELECT * FROM pemasukan_harian";
...
<head>
    ...
    <title>View Pemasukan Harian</title>
</head>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- View --- Pemasukan Harian</h5>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col class=" px-4""> Nomor Nota</th>
                            <th scope="col class=" px-4""> Tanggal</th>
                            <th scope="col class=" px-4""> Total Pemasukan</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($hasil)) { ?>
                        <tr>
                            <td class="p-2 text-center"><?=$row['nomor nota']; ?></td>
                            <td class="p-2 text-center"><?=$row['tanggal']; ?></td>
                            <td class="p-2 text-center">Rp.<?=$row['total pemasukan']; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
