...
// menjalankan query SELECT pada view sepatu_vans
$query1 = "SELECT * FROM sepatu_vans";
$vans = mysqli_query($koneksi, $query1);
?>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center mt-5">
        <div class="p-5">
            <h5 class="text-center">--- View --- Detail Sepatu Vans</h5>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col" class="px-4">Merk Sepatu</th>
                            <th scope="col" class="px-4">Model</th>
                            <th scope="col" class="px-4">Ukuran</th>
                            <th scope="col" class="px-4">Warna</th>
                            <th scope="col" class="px-4">Harga</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($vans)) { ?>
                        <tr>
                            <td class="p-2 text-center"><?= $row['merk sepatu']; ?></td>
                            <td class="p-2 text-center"><?= $row['model']; ?></td>
                            <td class="p-2 text-center"><?= $row['ukuran']; ?></td>
                            <td class="p-2 text-center"><?= $row['warna']; ?></td>
